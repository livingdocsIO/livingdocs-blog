...
// TODO <a className="logo" href="/"> should be a link - plz check
const Header = () => (
        ...
        <div className="meta-bar">
          ...
          <nav className="meta-nav">
            <div className="meta-nav__item">
              <a href="https://github.com/livingdocsIO/blog-example" target="_blank" rel="noopener noreferrer">Source Code</a>
            </div>
